...
4. **Deduplicate by content hash.** An attacker uploading the same 10 MB two hundred times should cost
...
So detection is item 5, not item 1, and it should be narrow: **the upload rate for one site jumping far
