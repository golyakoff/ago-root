...
- [ ] Every `*Errors`-shaped factory method's error code in `ago-chat` has a recorded, deliberate answer
...
- [ ] A decision, stated and reasoned, on whether an enforcing test (new code must be classified before
