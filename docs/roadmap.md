...
| # | Item | Why here |
|---|---|---|
| 1 | `11-10` the widget speaks the tenant's chosen language | Priority (author, 2026-08-27): closes the seam `ago-widget#22` named - the demo pages split by language, the widget inside them did not. Additive shape identical to `14-04`'s own precedent |
