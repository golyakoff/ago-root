...
| 4 | `14-02` MAX channel adapter | The first concrete channel, chosen because it has an open Bot API and no regulatory friction. A real bot token is in hand (2026-08-27), not yet placed in any repository |
