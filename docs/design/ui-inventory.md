...
| 5 | Каналы / Channels | Установка виджета `/channels/install` · Виджет на сайте `/channels/widget` · *Бот MAX (reserved)* · Бот Telegram `/channels/telegram` (`23-36`) · *Другие каналы (reserved)* | whole section needs `site:configure` |
